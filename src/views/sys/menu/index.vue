<template>
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-button v-waves class="filter-item" type="primary" icon="el-icon-search" v-perm="['/sys/menu/view']" @click="handleFilter">搜索</el-button>
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form ref="dataForm" :rules="rules" :model="temp" label-position="" label-width="90px" style="width: 400px; margin-left:50px;">
        ...
        <el-form-item :label="menuTypeList[temp.type] + '名称'" prop="title">
          <el-input v-model.trim="temp.title" placeholder="菜单名称" />
        </el-form-item>
        <el-form-item label="上级菜单" prop="parentName">
          <popup-tree-input :data="popupTreeData" :props="popupTreeProps" :prop="temp.parentName==null||temp.parentName==''?'顶级菜单':temp.parentName" :nodeKey="''+temp.parentId" :currentChangeHandle="handleTreeSelectChange">
          </popup-tree-input>
        </el-form-item>
        <el-form-item label="路由" prop="path">
          <el-input v-model.trim="temp.path" placeholder="菜单路由, 例 /sys, /sys/menu" />
        </el-form-item>
        ...
        <el-form-item label="排序ID">
          <el-input v-model.trim="temp.listorder" placeholder="" />
        </el-form-item>
